    ...
    public function __construct()
    {
        $this->register(
            ...
            new SettingDefinition(
                ...
                type:    'int',
                default: 480,
                label:   'Tägliche Regelarbeitszeit (Minuten)',
                min:     0,
                max:     1440,
            ),
            new SettingDefinition(
                ...
                type:    'int',
                default: 600,
                label:   'Tägliche Ausnahmearbeitszeit (Minuten)',
                min:     0,
                max:     1440,
            ),
            new SettingDefinition(
                ...
                type:    'int',
                default: 2400,
                label:   'Wöchentliche Regelarbeitszeit (Minuten)',
                min:     0,
                max:     10080,
            ),
            new SettingDefinition(
                ...
                type:    'int',
                default: 2700,
                label:   'Wöchentliche Ausnahmearbeitszeit (Minuten)',
                min:     0,
                max:     10080,
            ),
            new SettingDefinition(
